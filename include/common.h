...
class VideoEncodingParams {
 ...
 public:
  VideoEncodingParams(unsigned int width, unsigned int height,
  ...
  const unsigned int width() const { return this->_width; }
  const unsigned int height() const { return this->_height; }
  const unsigned int bitrate() const { return this->_bitrate; }
  const unsigned int fps() const { return this->_fps; }
  const AVPixelFormat pix_fmt() const { return this->_pix_fmt; }
};
