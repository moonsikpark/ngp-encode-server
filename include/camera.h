...
void framerequest_provider_thread(std::shared_ptr<VideoEncodingParams> veparams, std::shared_ptr<CameraManager> cameramgr, ThreadSafeQueue<nesproto::FrameRequest> &request_queue, std::atomic<bool> &shutdown_requested);
